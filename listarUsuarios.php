...
<form name="administrador" method="post" >
  <div align="center"><img src="images/admin.gif" width="800" height="200"> 
   <tr>VOLVER 
...
echo '<table cellpadding="0" cellspacing="0" width="100%">';
	echo '<thead><tr><td>Nro</td><td>Nombre Ususario</td><td>Cedula Identidad</td><td>Modificar</td</tr></thead>';
	...
	?> 
		<td width="20%"><a href="modificarUsusario.php?cod=+<?php  echo $fila['cod_usuario'];?>" target="popup"  onclick="window.open('','popup','width=500, height=350')"><img src="images/cambiar.PNG" width="24" height="24" border="0"></a></td></tr>
<?php
	}
	echo "</table>";
	?>
